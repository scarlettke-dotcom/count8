...
(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      project_item_meta: '{practiceCount} practice sessions · {foundationsCount} techniques identified',
      ...
      growth_stat_foundations: 'Foundations Learned',
      growth_trend_title: 'Score Trends Over Time',
      growth_foundations_title: 'Mastered Foundations',
      ...
      detail_foundations_title: 'Foundational Techniques',
      ...
      foundations_title: 'Foundational Techniques',
      foundations_status_identifying: 'Identifying foundational techniques…',
    ...
    zh: {
      ...
      project_item_meta: '{practiceCount} 次练习 · 识别出 {foundationsCount} 个基本功',
      ...
      foundations_title: '基本功识别',
      foundations_status_identifying: '正在识别基本功…',
